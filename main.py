...
load_dotenv()
import torch
from database import open_parquet, create_outcome, get_data, get_vars, DB_PATH
...
if __name__ == '__main__':
    ...
    clf, train_embeddings, test_embeddings, data = get_tabpfn_model(df, get_embeddings=True)
